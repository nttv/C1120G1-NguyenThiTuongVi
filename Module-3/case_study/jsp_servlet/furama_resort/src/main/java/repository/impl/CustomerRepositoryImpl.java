...
public class CustomerRepositoryImpl implements CustomerRepository {
    ...
    public static final String ADD_CUSTOMER = "insert into customer(customer_type_id,customer_name,customer_birthday," +
            "customer_gender,customer_id_card,customer_phone,customer_email,customer_address) values(?,?,?,?,?,?,?,?)";
    public static final String UPDATE_CUSTOMER = "update customer set customer_type_id = ?, customer_name = ?," +
